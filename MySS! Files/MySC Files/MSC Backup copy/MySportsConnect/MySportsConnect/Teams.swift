...
class Teams: SKScene
{
    ...
    var Page1Teams:[String] = ["None","None","None","None","None","None","None","None"]
    ...
    override func didMove(to view: SKView)
    {
        ...
        //print("How many teams: \(DivisionTeams.count)")
        
        //Page 1 of Teams
        if(DivisionTeams.count > 0 && DivisionTeams.count >= 8)//8 is max number displayed on screen
        {
            var bound = 0
            ...
            {
                Page1Teams[index] = (DivisionTeams[index])
            }
        }
        //Page 2
        if(DivisionTeams.count > 8)
    ...
    override func touchesMoved(_ touches: Set<UITouch>, with event: UIEvent?)
    {
        ...
        for touch: AnyObject in touches
        {
            ...
            //let buttonWidth = tempb.size.width
            //print(buttonWidth)
            //print(DivisionTeams[0])
