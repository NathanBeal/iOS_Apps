...
class GameScene: SKScene
{
    ...
    var backArrXCoord = CGFloat(); var backArrYCoord = CGFloat()
    ...
    override func didMove(to view: SKView)
    {
        ...
        //Check to see if tour hand is full
        checkHand()
        
        //Display your card(s) on screen
        displayCards()
    ...
    func randAvailCard() -> String
    {
        ...
        let cards = allCardsArray()
        let randomCard = cards[Int.random(in:0 ..< cards.count-1)]
        
        return randomCard
    }
    
    //Populates Array of All cards
