...
class diamondSelect: SKScene
{
    ...
    override func didMove(to view: SKView)
    {
        ...
        //Alphas
        backArrow.alpha = 0; Directions.alpha = 0; Cards.dTwo.alpha = 0; Cards.dThree.alpha = 0; Cards.dFour.alpha = 0; Cards.dFive.alpha = 0; Cards.dSix.alpha = 0; Cards.dSeven.alpha = 0; Cards.dEight.alpha = 0; Cards.dNine.alpha = 0; Cards.dTen.alpha = 0; Cards.dJack.alpha = 0; Cards.dQueen.alpha = 0; Cards.dKing.alpha = 0; Cards.dAce.alpha = 0
