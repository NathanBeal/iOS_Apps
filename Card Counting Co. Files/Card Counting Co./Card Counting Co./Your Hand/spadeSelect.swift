...
class spadeSelect: SKScene
{
    ...
    override func didMove(to view: SKView)
    {
        ...
        //Alphas
        backArrow.alpha = 0; Directions.alpha = 0; Cards.sTwo.alpha = 0; Cards.sThree.alpha = 0; Cards.sFour.alpha = 0; Cards.sFive.alpha = 0; Cards.sSix.alpha = 0; Cards.sSeven.alpha = 0; Cards.sEight.alpha = 0; Cards.sNine.alpha = 0; Cards.sTen.alpha = 0; Cards.sJack.alpha = 0; Cards.sQueen.alpha = 0; Cards.sKing.alpha = 0; Cards.sAce.alpha = 0
