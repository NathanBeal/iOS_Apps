...
class gamePlay: SKScene
{
    ...
    //Extra Players
    let extraCard1 = SKSpriteNode(imageNamed: "Back Of Card"); let extraCard2 = SKSpriteNode(imageNamed: "Back Of Card"); let extraCard3 = SKSpriteNode(imageNamed: "Back Of Card"); let extraCard4 = SKSpriteNode(imageNamed: "Back Of Card"); let extraCard5 = SKSpriteNode(imageNamed: "Back Of Card"); let extraCard6 = SKSpriteNode(imageNamed: "Back Of Card"); let extraCard7 = SKSpriteNode(imageNamed: "Back Of Card"); let extraCard8 = SKSpriteNode(imageNamed: "Back Of Card"); let extraCard9 = SKSpriteNode(imageNamed: "Back Of Card"); let extraCard10 = SKSpriteNode(imageNamed: "Back Of Card")
    ...
    {
        statisticsLabel1.removeFromParent(); statisticsLabel2.removeFromParent(); statisticsLabel3.removeFromParent(); statisticsLabel4.removeFromParent(); statisticsLabel5.removeFromParent()
        statsLabel1.removeFromParent(); statsLabel2.removeFromParent(); statsLabel3.removeFromParent(); statsLabel4.removeFromParent(); statsLabel5.removeFromParent()
    ...
    func handRanking(handSize: Int) -> Int
    {
        ...
        let suitCard1 = holeCard1Array[0]; let suitCard2 = holeCard2Array[0]; let suitCard3 = flopCard1Array[0]; let suitCard4 = flopCard2Array[0]; let suitCard5 = flopCard3Array[0]
        let valCard1 = holeCard1Array[1]
        let valCard2 = holeCard2Array[1]
