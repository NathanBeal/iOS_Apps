...
class heartSelectFlop: SKScene
{
    ...
    override func touchesBegan(_ touches: Set<UITouch>, with event: UIEvent?)
    {
        for touch: AnyObject in touches
        {
            ...
            if passes(Tester: "Heart - 2") == true
            {
                if (pointOfTouch.x > (2.6/10 * self.size.width - cardWidth/2) && pointOfTouch.x < (2.6/10 * self.size.width + cardWidth/2)) && (pointOfTouch.y > (2/10 * self.size.height - cardHeight/2) && pointOfTouch.y < (2/10 * self.size.height + cardHeight/2))
                {
                    let key = pos()
            ...
            if passes(Tester: "Heart - 3") == true
            {
                if (pointOfTouch.x > (4.2/10 * self.size.width - cardWidth/2) && pointOfTouch.x < (4.2/10 * self.size.width + cardWidth/2)) && (pointOfTouch.y > (2.75/10 *  self.size.height - cardHeight/2) && pointOfTouch.y < (2/10 * self.size.height + cardHeight/10))
                {
                    let key = pos()
