...
class GameSceneRiver: SKScene
{
    ...
    override func didMove(to view: SKView)
    {
        ...
        selectLabel.text = "select the river card"
    ...
    {
        if defaults.string(forKey: "Card1") != Tester && defaults.string(forKey: "Card2") != Tester && defaults.string(forKey: "Flop1") != Tester && defaults.string(forKey: "Flop2") != Tester && defaults.string(forKey: "Flop3") != Tester && Tester != defaults.string(forKey: "Turn") && Tester != defaults.string(forKey: "River")
        {
            return true
        }
        return false
    ...
    func displayCards()
    {
        let key1 = defaults.string(forKey: "River")
        
        if key1 != "None"
        {
            temp = SKSpriteNode(imageNamed: defaults.string(forKey: "River")!)
    ...
    func fadeOut(exitNumber: Int)
    {
        ...
        if exitNumber == 0
        {
            sceneToMoveTo = heartSelectRiver(size: self.size)
        }
        if exitNumber == 1
        {
            sceneToMoveTo = clubSelectRiver(size: self.size)
        }
        if exitNumber == 2
        {
            sceneToMoveTo = diamondSelectRiver(size: self.size)
        }
        if exitNumber == 3
        {
            sceneToMoveTo = spadeSelectRiver(size: self.size)
        }
        if exitNumber == 4
        {
